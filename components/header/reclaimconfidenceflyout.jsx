        ...
        <div className={styles.flyoutContent}>
          ...
          <div className={styles.eventInfo}>
            ...
            <div className={styles.eventDetails}>
              ...
              <div className={styles.eventDate}>July 31st, 11 AM–7 PM</div>
          ...
          <div className={styles.actionButtons}>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              Book Pre-Screening with Dr. Gigi
            </a>
          </div>
          ...
          <div className={styles.hashtagList}>
            <div className={styles.hashtagRow}>
              <span className={styles.hashtagText}>#PelvicHealthRecovery</span>
              <div className={styles.hashtagLinks}>
                <div className={styles.splitButton}>
                  <a 
                    href="https://www.instagram.com/explore/tags/pelvichealthrecovery/" 
                  ...
                  <a 
                    href="https://www.facebook.com/hashtag/pelvichealthrecovery" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className={styles.hashtagRow}>
              <span className={styles.hashtagText}>#GarciaFamilyMedicine</span>
              <div className={styles.hashtagLinks}>
                <div className={styles.splitButton}>
                  <a 
                    href="https://www.instagram.com/explore/tags/garciafamilymedicine/" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Instagram"
                  ...
                  <a 
                    href="https://www.facebook.com/hashtag/garciafamilymedicine" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Facebook"
            ...
            <div className={styles.hashtagRow}>
              <span className={styles.hashtagText}>#IncontinenceRelief</span>
              <div className={styles.hashtagLinks}>
                <div className={styles.splitButton}>
                  <a 
                    href="https://www.instagram.com/explore/tags/incontinencerelief/" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Instagram"
                  ...
                  <a 
                    href="https://www.facebook.com/hashtag/incontinencerelief" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Facebook"
            ...
            <div className={styles.hashtagRow}>
              <span className={styles.hashtagText}>#EDHelp</span>
              <div className={styles.hashtagLinks}>
                <div className={styles.splitButton}>
                  <a 
                    href="https://www.instagram.com/explore/tags/edhelp/" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Instagram"
                  ...
                  <a 
                    href="https://www.facebook.com/hashtag/edhelp" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Facebook"
            ...
            <div className={styles.hashtagRow}>
              <span className={styles.hashtagText}>#ConfidenceRestored</span>
              <div className={styles.hashtagLinks}>
                <div className={styles.splitButton}>
                  <a 
                    href="https://www.instagram.com/explore/tags/confidencerestored/" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Instagram"
                  ...
                  <a 
                    href="https://www.facebook.com/hashtag/confidencerestored" 
                    className={styles.socialHashtag}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="View on Facebook"
