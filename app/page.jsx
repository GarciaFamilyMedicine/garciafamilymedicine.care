...
export default function Home() {
  ...
  /* close Ask‑Dr‑Tess popup when clicking overlay */
  useEffect(() => {
    const close = (e) => { if (e.target.id === 'popup') setIsPopupOpen(false); };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans flex flex-col">
      ...
      {/* spacer equal to top‑bar + navbar height (25 + 60) */}
      <div style={{ height: 'calc(25px + 60px)' }} aria-hidden />

      {/* hero carousel */}
      <Carousel />

      {/* ─────────────── MAIN BODY ─────────────── */}
      <main className="flex flex-col items-center px-4 py-12 sm:py-20 flex-grow">
        {/* welcome card */}
        <div className="main-welcome-card bg-white/60 backdrop-blur-lg p-8 rounded-lg shadow-md max-w-5xl w-full text-center">
          ...
          <p className="main-welcome-p text-gray-600 text-lg text-justify font-argentum leading-relaxed mb-4 indent-5">
            ...
            <strong>simple, affordable, and deeply personal—</strong>because you&apos;re more than a patient, you&apos;re family.
            We&apos;ve stepped away from the traditional insurance system to deliver&nbsp;
            <strong>high‑quality primary care</strong> and mental‑health support that&apos;s cost‑effective, compassionate,
          ...
          <div
            id="moreContent"
            className={`care-section transition-all duration-300 ${
          ...
          >
            ...
            <ul className="text-gray-600 text-base font-argentum mb-4 text-justify list-disc pl-6">
              <li className="mb-2"><strong>Loving Care:</strong> From preventive checkups to managing chronic conditions like diabetes or hypertension, plus mental health support filled with empathy.</li>
              <li className="mb-2"><strong>Heavenly Convenience:</strong> Quick, easy appointments that honor your time and needs.</li>
              <li className="mb-2"><strong>Affordable Blessings:</strong> Transparent pricing that brings peace to your wallet and soul.</li>
            </ul>
            <p className="text-gray-600 text-base text-justify font-argentum leading-relaxed mb-4 indent-5">
            ...
            <p className="text-gray-600 text-base text-justify font-argentum leading-relaxed mb-4 indent-5">
              ...
              <a href="tel:816-427-5320" className="text-[#275cab] font-semibold hover:underline">816‑427‑5320</a>&nbsp;now—let us welcome you into our family! Join the countless patients in Blue Springs, Independence, Lee&apos;s Summit, and the Kansas City metro area who&apos;ve found healing and hope with us. Dial&nbsp;
              <a href="tel:816-427-5320" className="text-[#275cab] font-semibold hover:underline">816‑427‑5320</a>&nbsp;today and discover the joy of <strong>compassionate, faith‑filled healthcare</strong> that&apos;s as reliable as it is remarkable. Your well‑being is our calling—let&apos;s start this journey together!
            </p>
            <a
        ...
        <div className="comments-section bg-white/60 backdrop-blur-lg p-6 rounded-lg shadow-md max-w-5xl w-full text-center mt-6">
          ...
          <p className="text-gray-600 text-base font-argentum leading-relaxed mb-4 indent-5">
            ...
            <a href="tel:816-427-5320" className="text-[#275cab] font-semibold hover:underline">816‑427‑5320</a>&nbsp;for a personal chat.
          </p>
          <button
        ...
        <div
          id="popup"
          className={`fixed inset-0 bg-black/70 flex justify-center items-center z-[2147483647] transition-opacity duration-300 ${
