      ...
      <section className={styles.insuranceSection}>
        ...
        <div className={styles.insuranceContent}>
          ...
          <div className={styles.paymentInfo}>
            <h3>Affordable Payment Options</h3>
            <p>No insurance? No problem! We offer competitive cash pay rates and flexible payment plans for all virtual visits.</p>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Link href="/services/cash-pay" className={styles.learnMoreLink}>
                Cash Pay Options →
              </Link>
              <Link href="/services/payment-plans" className={styles.learnMoreLink}>
                Payment Plans →
              </Link>
            </div>
          </div>
